...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-07-2019 a las 01:36:47
...
INSERT INTO `devolucion` (`devolucion_id`, `libro_id`, `devoluciont`, `fechadevolucion`) VALUES
(1, 1, 1, '2019-12-20');
...
--
-- Volcado de datos para la tabla `devolucionbak`
--

INSERT INTO `devolucionbak` (`devolucion_id`, `libro_id`, `devoluciont`, `fechadevolucion`) VALUES
(1, 1, 1, '2019-12-20');
...
INSERT INTO `prestamos` (`prestamo_id`, `libro_id`, `prestamot`, `fechaentrega`) VALUES
(1, 1, 1, '20-08-2019'),
(2, 1, 1, '2019-12-24');
...
--
-- Volcado de datos para la tabla `prestamosbak`
--

INSERT INTO `prestamosbak` (`prestamo_id`, `libro_id`, `prestamot`, `fechaentrega`) VALUES
(1, 1, 1, '20-08-2019'),
(2, 1, 1, '2019-12-24');
...
INSERT INTO `usuario` (`usu_id`, `password`, `nombre`, `apellido`, `dni`, `telefono`) VALUES
(1, 'password123', 'Pablo', 'Vega Valverde', 76621871, 980251512);
...
--
-- Volcado de datos para la tabla `usuariobak`
--

INSERT INTO `usuariobak` (`usu_id`, `password`, `nombre`, `apellido`, `dni`, `telefono`) VALUES
(1, 'password123', 'Pablo', 'Vega Valverde', 76621871, 980251512);
...
--
ALTER TABLE `devolucion`
  MODIFY `devolucion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
